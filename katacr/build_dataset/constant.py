...
path_dataset = Path("C:/Disk_D/RL_Finance/Clash-Royale-Detection-Dataset")
...
split_bbox_params = {  # format: [x_top_left, y_top_left, width, hight]
  ...
  ## older version: 'part1_2.16': (0.835, 0.063, 0.165, 0.038),  # left top time
  'part1_2.16': (0.835, 0.05, 0.165, 0.038),  # left top time
  # 'part1': {  # number ocr
  ...
  'part3_2.16': (0.000, 0.84, 1.000, 0.155),  # card table
  #'part4_2.16': {  # center word ocr
  #  'up': (0.100, 0.340, 0.800, 0.070),
  #  'mid': (0.180, 0.410, 0.650, 0.050),
  #},
  'part4_2.16': (0.835, 0.065, 0.165, 0.03),  # left top time
...
part3_bbox_params = [  # Configure for card positions in part3, card position is left to right
                            (0.047, 0.940, 0.100, 0.09),  # next card
                            (0.222, 0.85, 0.2, 0.12),  # card1
                            (0.410, 0.85, 0.2, 0.12),  # card2
                            (0.600, 0.85, 0.2, 0.12),  # card3
                            (0.785, 0.85, 0.2, 0.12),  # card4
                            ]
'''

part3_elixir_params = (0.262, 0.770, 0.067, 0.16)
